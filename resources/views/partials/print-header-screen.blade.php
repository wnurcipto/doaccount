...
<div class="print-header-screen" style="border-bottom: 2px solid #333; padding-bottom: 15px; margin-bottom: 20px;">
    <div style="display: flex; align-items: flex-start; gap: 20px;">
        ...
        <div style="flex: 1; min-width: 0;">
            <h3 style="margin: 0 0 8px 0; font-weight: bold; color: #333; font-size: 18px;">{{ $company->nama_perusahaan }}</h3>
            @if($company->alamat)
