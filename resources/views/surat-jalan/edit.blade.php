...
@section('title', 'Edit Surat Jalan - ' . $suratJalan->no_surat_jalan)
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('surat-jalan.update', $suratJalan) }}" method="POST" id="suratJalanForm">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('no_surat_jalan') is-invalid @enderror" 
                               id="no_surat_jalan" name="no_surat_jalan" value="{{ old('no_surat_jalan', $suratJalan->no_surat_jalan) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('dari_nama') is-invalid @enderror" 
                               id="dari_nama" name="dari_nama" value="{{ old('dari_nama', $suratJalan->dari_nama) }}" required>
                        @error('dari_nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('dari_telepon') is-invalid @enderror" 
                               id="dari_telepon" name="dari_telepon" value="{{ old('dari_telepon', $suratJalan->dari_telepon) }}">
                        @error('dari_telepon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        ...
                        <textarea class="form-control @error('dari_alamat') is-invalid @enderror" 
                                  id="dari_alamat" name="dari_alamat" rows="2">{{ old('dari_alamat', $suratJalan->dari_alamat) }}</textarea>
                        @error('dari_alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('dari_kota') is-invalid @enderror" 
                               id="dari_kota" name="dari_kota" value="{{ old('dari_kota', $suratJalan->dari_kota) }}">
                        @error('dari_kota')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('kepada_nama') is-invalid @enderror" 
                               id="kepada_nama" name="kepada_nama" value="{{ old('kepada_nama', $suratJalan->kepada_nama) }}" required>
                        @error('kepada_nama')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('kepada_telepon') is-invalid @enderror" 
                               id="kepada_telepon" name="kepada_telepon" value="{{ old('kepada_telepon', $suratJalan->kepada_telepon) }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        ...
                        <textarea class="form-control @error('kepada_alamat') is-invalid @enderror" 
                                  id="kepada_alamat" name="kepada_alamat" rows="2">{{ old('kepada_alamat', $suratJalan->kepada_alamat) }}</textarea>
                        @error('kepada_alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('kepada_kota') is-invalid @enderror" 
                               id="kepada_kota" name="kepada_kota" value="{{ old('kepada_kota', $suratJalan->kepada_kota) }}">
                        @error('kepada_kota')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('no_kendaraan') is-invalid @enderror" 
                               id="no_kendaraan" name="no_kendaraan" value="{{ old('no_kendaraan', $suratJalan->no_kendaraan) }}">
                        @error('no_kendaraan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_supir') is-invalid @enderror" 
                               id="nama_supir" name="nama_supir" value="{{ old('nama_supir', $suratJalan->nama_supir) }}">
                        @error('nama_supir')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                              id="keterangan" name="keterangan" rows="3">{{ old('keterangan', $suratJalan->keterangan) }}</textarea>
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-between mt-3">
                    <a href="{{ route('surat-jalan.show', $suratJalan) }}" class="btn btn-secondary">Batal</a>
...
<script>
let itemIndex = 0;
const items = @json($suratJalan->items);
