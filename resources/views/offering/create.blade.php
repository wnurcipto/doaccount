...
@section('title', 'Buat Offering Baru')

@section('content')
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0">Form Input Offering</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('offering.store') }}" method="POST" id="offeringForm">
                @csrf
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('no_offering') is-invalid @enderror" 
                               id="no_offering" name="no_offering" value="{{ old('no_offering', $noOffering) }}" required>
                        @error('no_offering')
                ...
                <div class="d-flex justify-content-between mt-3">
                    <a href="{{ route('offering.index') }}" class="btn btn-secondary">Batal</a>
                    <button type="submit" class="btn btn-primary">Simpan Offering</button>
                </div>
            </form>
        </div>
    </div>
