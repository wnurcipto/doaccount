...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0">Form Input Invoice</h4>
        </div>
        <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('no_invoice') is-invalid @enderror" 
                               id="no_invoice" name="no_invoice" value="{{ old('no_invoice', $noInvoice) }}" required>
                        @error('no_invoice')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('term_condition') is-invalid @enderror" 
                                  id="term_condition" name="term_condition" rows="8">{{ old('term_condition') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control @error('payment_terms') is-invalid @enderror" 
                                  id="payment_terms" name="payment_terms" rows="8">{{ old('payment_terms') }}</textarea>
                        @error('payment_terms')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control text-end" id="diskon" name="diskon" 
                                           value="{{ old('diskon', 0) }}" min="0" step="0.01" onchange="calculateTotal()">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control text-end" id="ppn" name="ppn" 
                                           value="{{ old('ppn', 0) }}" min="0" step="0.01" onchange="calculateTotal()">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="number" class="form-control text-end" id="dp" name="dp" 
                                           value="{{ old('dp', 0) }}" min="0" step="0.01" onchange="calculateTotal()">
                                </td>
                            </tr>
...
2. Pembayaran dapat dilakukan melalui:
   - Transfer Bank ke rekening: 0824439611 / 8010863342
   - Bank: BNI / BCA
   - Atas Nama: WAHID NURCIPTO
